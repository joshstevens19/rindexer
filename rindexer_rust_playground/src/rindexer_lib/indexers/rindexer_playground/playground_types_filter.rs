...
async fn swap_handler(manifest_path: &PathBuf, registry: &mut EventCallbackRegistry) {
    PlaygroundTypesFilterEventType::Swap(
                    ...
                    for result in results.iter() {
                        csv_bulk_data.push(vec![format!("{:?}", result.tx_information.address),format!("{:?}", result.event_data.sender,),format!("{:?}", result.event_data.recipient,),result.event_data.amount_0.to_string(),result.event_data.amount_1.to_string(),result.event_data.sqrt_price_x96.to_string(),result.event_data.liquidity.to_string(),result.event_data.tick.to_string(),result.event_data.tick_2.to_string(),result.event_data.tick_3.to_string(),result.event_data.tick_4.to_string(),result.event_data.tick_5.to_string(),result.event_data.tick_6.to_string(),result.event_data.tick_7.to_string(),format!("{:?}", result.tx_information.transaction_hash),result.tx_information.block_number.to_string(),result.tx_information.block_hash.to_string(),result.tx_information.network.to_string(),result.tx_information.transaction_index.to_string(),result.tx_information.log_index.to_string()]);
                        let data = vec![EthereumSqlTypeWrapper::Address(result.tx_information.address),EthereumSqlTypeWrapper::Address(result.event_data.sender),EthereumSqlTypeWrapper::Address(result.event_data.recipient),EthereumSqlTypeWrapper::I256(result.event_data.amount_0),EthereumSqlTypeWrapper::I256(result.event_data.amount_1),EthereumSqlTypeWrapper::U256(result.event_data.sqrt_price_x96),EthereumSqlTypeWrapper::U128(result.event_data.liquidity),EthereumSqlTypeWrapper::I32(result.event_data.tick),EthereumSqlTypeWrapper::I8(result.event_data.tick_2),EthereumSqlTypeWrapper::I16(result.event_data.tick_3),EthereumSqlTypeWrapper::I32(result.event_data.tick_4),EthereumSqlTypeWrapper::I64(result.event_data.tick_5),EthereumSqlTypeWrapper::I128(result.event_data.tick_6),EthereumSqlTypeWrapper::I256(result.event_data.tick_7),EthereumSqlTypeWrapper::B256(result.tx_information.transaction_hash),EthereumSqlTypeWrapper::U64(result.tx_information.block_number),EthereumSqlTypeWrapper::B256(result.tx_information.block_hash),EthereumSqlTypeWrapper::String(result.tx_information.network.to_string()),EthereumSqlTypeWrapper::U64(result.tx_information.transaction_index),EthereumSqlTypeWrapper::U256(result.tx_information.log_index)];;
