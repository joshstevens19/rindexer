    ...
    TExtensions: Send + Sync + 'static,
{
    ...
    {
        let csv = AsyncCsvAppender::new(
            r"/Users/pawellula/RustroverProjects/rindexer/cli/../rindexer_rust_playground/generated_csv/UniswapV3Factory/uniswapv3factory-poolcreated.csv",
        );
        if !Path::new(r"/Users/pawellula/RustroverProjects/rindexer/cli/../rindexer_rust_playground/generated_csv/UniswapV3Factory/uniswapv3factory-poolcreated.csv").exists() {
