    ...
    TExtensions: Send + Sync + 'static,
{
        ...
        Fut: Future<Output = EventCallbackResult<()>> + Send + 'static,
    {
        let csv = AsyncCsvAppender::new(
            r"/Users/pawellula/RustroverProjects/rindexer/cli/../rindexer_rust_playground/generated_csv/PlaygroundTypesFilter/playgroundtypesfilter-swap.csv",
        );
        if !Path::new(r"/Users/pawellula/RustroverProjects/rindexer/cli/../rindexer_rust_playground/generated_csv/PlaygroundTypesFilter/playgroundtypesfilter-swap.csv").exists() {
