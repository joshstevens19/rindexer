...
You can follow this guide to setup a bot [here](https://www.writebots.com/discord-bot-token/).

Make sure you copy your bot token as you will need it later.
...
You have add your bot to channel to use it, so this is the chhanel ID you wish the bot to send messages to.
