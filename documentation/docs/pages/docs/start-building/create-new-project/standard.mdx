...
:::tip
This guide covers the standard setup process. For high-performance production deployments using Reth, see [Reth Mode](/docs/start-building/create-new-project/reth-mode).
:::
