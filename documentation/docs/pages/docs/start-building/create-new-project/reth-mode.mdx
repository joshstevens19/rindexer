...
:::warning
Reth mode requires running a Reth archive node and is intended for advanced users. If you're just getting started, consider using [Standard Mode](/docs/start-building/create-new-project/standard) instead.
:::
