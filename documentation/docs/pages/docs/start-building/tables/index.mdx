...
factory-created vaults or pools) can be grouped - the group trails the factory's discovery checkpoint so child
address sets stay complete - but a contract used as a factory SOURCE cannot. See the
