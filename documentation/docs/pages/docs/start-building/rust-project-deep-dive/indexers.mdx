        ...
        TransferEvent::handler(
            |results, context| async move {
                ...
                match response { // [!code focus]
                    Ok(response) => println!("{}", response), // [!code focus]
                    Err(e) => println!("Error: {:?}", e), // [!code focus]
                } // [!code focus]
            },
...
```rs
use crate::rindexer::typings::networks::get_ethereum_provider;// [!code focus]
        ...
        TransferEvent::handler(
            |results, context| async move {
                ...
                match chain_id { // [!code focus]
                    Ok(result) => {println!("Chain id: {:?}", result)} // [!code focus]
                    Err(e) => {println!("Error getting chain id: {:?}", e)} // [!code focus]
                } // [!code focus]
            },
            no_extensions(),
        )
...
```rs
use crate::rindexer::typings::global_contracts::usdt_contract; // [!code focus]
        ...
        TransferEvent::handler(
            |results, context| async move {
                ...
                match name { // [!code focus]
                    Ok(result) => {println!("USDT name: {:?}", name)} // [!code focus]
                    Err(e) => {println!("Error getting USDT name: {:?}", e)} // [!code focus]
                } // [!code focus]
            },
            no_extensions(),
        )
...
```rs
use crate::rindexer::typings::rust::events::rocket_pool_eth::rocket_pool_eth_contract; // [!code focus]
    ...
    RocketPoolETHEventType::Transfer(
        TransferEvent::handler(
            |results, context| async move {
                ...
                match name { // [!code focus]
                    Ok(result) => {println!("rETH name: {:?}", name)} // [!code focus]
                    Err(e) => {println!("Error getting rETH name: {:?}", e)} // [!code focus]
                } // [!code focus]
            },
            no_extensions(),
        )
...
When you start changing your YAML configuration file and regen your typings the indexer functions may break or need editing
