...
By default it will point to `http://localhost:5005` graphql endpoint, you can change this by passing the endpoint flag:
...
const config: CodegenConfig = {
  ...
  schema: 'http://localhost:5005/graphql', // [!code focus]
  ...
}
