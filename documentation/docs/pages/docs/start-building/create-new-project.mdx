...
If you are using postgres storage with docker support you will need to make sure you have docker running on your machine
before starting the project then you can run the following command:
