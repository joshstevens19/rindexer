      ...
      - bot_token: ${TELEGRAM_BOT_TOKEN} // [!code focus]
        ...
        messages:
          - event_name: Transfer // [!code focus]
            ...
            template_inline: 'Transfer from {{from}} to {{to}} value {{value}} for token {{transaction_information.address}}' // [!code focus]
```
...
You also can use the `transaction_information` object to get information about the transaction, this is the
  ...
  chat: // [!code focus]
    telegram: // [!code focus]
      - bot_token: ${TELEGRAM_BOT_TOKEN}
        ...
        messages:
          - event_name: Transfer // [!code focus]
          - template_inline: 'Transfer from {{from}} to {{to}} value {{value}} for token {{transaction_information.address}}'
```