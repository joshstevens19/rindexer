...
#### Index more then 1 filter

To use more then 1 filter at the moment you have to add a new entry in the details, we will merge this into `event_name`
soon which will turn this into accepting an singular filter details or an array of filter details https://github.com/joshstevens19/rindexer/issues/40.

For now you have to do it like this:
