...
`Goldsky` is a great indexing tool which is very feature rich and has a lot of great features. They have the concept
of mirroring events which in turn is no-code style and offer bespoke services to build custom indexing solutions.