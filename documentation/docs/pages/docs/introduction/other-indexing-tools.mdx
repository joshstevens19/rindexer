...
`GhostGraph` makes it easy to build blazingly fast indexers (subgraphs) for smart contracts.

`GhostGraph` is the first indexing solution that lets you write your index transformations in Solidity.