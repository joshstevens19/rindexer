...
- Add xtask with block timestamp encoding mechanism
- Adds nocode postgres migration "versioning system"
- Expose a rust project handler to process raw blocks with transactions if native indexing is enabled.
