...
- Enhance filter conditions parsing and evaluation to handle complex expressions with logical operators

### Bug fixes
-------------------------------------------------

- Fix logical operators precedence in filter conditions
