...
# 0.36.0-beta - 24th Match 2026

github branch - https://github.com/joshstevens19/rindexer/tree/release/0.36.0

- linux binary - https://github.com/joshstevens19/rindexer/releases/download/v0.36.0/rindexer_linux-amd64.tar.gz
- mac apple silicon binary - https://github.com/joshstevens19/rindexer/releases/download/v0.36.0/rindexer_darwin-arm64.tar.gz
- mac apple intel binary - https://github.com/joshstevens19/rindexer/releases/download/v0.36.0/rindexer_darwin-amd64.tar.gz
- windows binary - https://github.com/joshstevens19/rindexer/releases/download/v0.36.0/rindexer_win32-amd64.zip
