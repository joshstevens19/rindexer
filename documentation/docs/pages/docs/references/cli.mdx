...
```bash
Example: `rindexer phantom init` or `rindexer phantom clone <contract::name> <network>` or `rindexer phantom compile <contract::name> <network>` or `rindexer phantom deploy <contract::name> <network>`
