...
use super::super::super::typings::rindexer_factory_contract::events::rocket_pool_eth::{
            ...
            if postgres_bulk_data.len() > 100 {
                let result = context
                    ...
                    .bulk_insert_via_copy(
                        "rindexer_factory_contract_rocket_pool_eth.approval",
                        &rows,
                        &postgres_bulk_data
                            .first()
        ...
        |results, context| async move {
            ...
            if postgres_bulk_data.len() > 100 {
                let result = context
                    .database
                    .bulk_insert_via_copy(
                        "rindexer_factory_contract_rocket_pool_eth.transfer",
                        &rows,
                        &postgres_bulk_data
                            .first()
                            .ok_or("No first element in bulk data, impossible")?
