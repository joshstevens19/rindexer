    ...
    TExtensions: Send + Sync + 'static,
{
        ...
        Fut: Future<Output = EventCallbackResult<()>> + Send + 'static,
    {
        let csv = AsyncCsvAppender::new(
            r"/Users/pawellula/RustroverProjects/rindexer/cli/../examples/rindexer_factory_indexing/generated_csv/UniswapV3FactoryPoolCreatedToken0Token1/uniswapv3factorypoolcreatedtoken0token1-poolcreated.csv",
        );
        if !Path::new(r"/Users/pawellula/RustroverProjects/rindexer/cli/../examples/rindexer_factory_indexing/generated_csv/UniswapV3FactoryPoolCreatedToken0Token1/uniswapv3factorypoolcreatedtoken0token1-poolcreated.csv").exists() {
