...
pub type EtherDepositedData = RindexerRocketPoolETHGen::EtherDeposited;
...
pub type TokensBurnedData = RindexerRocketPoolETHGen::TokensBurned;
...
pub type TokensMintedData = RindexerRocketPoolETHGen::TokensMinted;
    ...
    TExtensions: Send + Sync + 'static,
{
        ...
        Fut: Future<Output = EventCallbackResult<()>> + Send + 'static,
    {
        let csv = AsyncCsvAppender::new(
            r"/Users/pawellula/RustroverProjects/rindexer/cli/../examples/RindexerFactoryContract/generated_csv/RocketPoolETH/rocketpooleth-approval.csv",
        );
        if !Path::new(r"/Users/pawellula/RustroverProjects/rindexer/cli/../examples/RindexerFactoryContract/generated_csv/RocketPoolETH/rocketpooleth-approval.csv").exists() {
    ...
    TExtensions: Send + Sync + 'static,
{
    ...
    {
        let csv = AsyncCsvAppender::new(
            r"/Users/pawellula/RustroverProjects/rindexer/cli/../examples/RindexerFactoryContract/generated_csv/RocketPoolETH/rocketpooleth-transfer.csv",
        );
        if !Path::new(r"/Users/pawellula/RustroverProjects/rindexer/cli/../examples/RindexerFactoryContract/generated_csv/RocketPoolETH/rocketpooleth-transfer.csv").exists() {
