...
use crate::database::common_sql::generate::{generate_indexer_contract_schema_name, GenerateTablesForIndexerSqlError};
...
pub fn generate_tables_for_indexer_clickhouse(
    ...
    for contract in &indexer.contracts {
        ...
        sql.push_str(&generate_internal_event_table_clickhouse(&event_names, &schema_name, networks));
    }
